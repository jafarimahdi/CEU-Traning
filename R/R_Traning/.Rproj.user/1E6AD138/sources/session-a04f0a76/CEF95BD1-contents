...
# mtCars is a ready data for the cars
cars <- mtcars
...
# change the data for one the column $weightLb 
...
# find the minimum element in the "qsec" column in the mtcars table, 
#   in those have less then 200 "hp" in all the table
mtcars 
