...
# ui <- fluidPage(
#       tabsetPanel(
#         tabPanel('control', uiOutput('my_ticker'),dateRangeInput('my_date',label = 'Date', start = '2018-01-01', end = Sys.Date())),
#         tabPanel("plot",plotlyOutput('data_plot', width = '60%', height='800px')),
#         tabPanel('data',dataTableOutput('my_data')),
#       )
# )
...
# ---- step -3 
# ui <- navbarPage("Stock Browser",theme = shinytheme("cosmo"),
#     tabPanel('Control', uiOutput('my_ticker'),dateRangeInput('my_date',label = 'Date', start = '2018-01-01', end = Sys.Date())),
#     tabPanel("Plot",plotlyOutput('data_plot', width = '60%', height='800px')),
#     tabPanel('Data',dataTableOutput('my_data'))
# )

# ----- step -4 work with Dashboard 
